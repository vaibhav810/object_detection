...
class TextDataSet(DataSet):
  ...
  def record_process(self, record):
    ...
    """
    #print('record is %d')%record[0]
    image = cv2.imread(record[0])
    #image = cv2.imread('//home//softnautics//vaibhav_ml//yolo_tensorflow_thread//tensorflow-yolo//data//VOCdevkit2007//VOC2007//JPEGImages//n04487081_10462.JPEG')

#    image1 =    cv2.imread('/home/softnautics/vaibhav_ml/yolo_tensorflow_thread/tensorflow-yolo/data/VOCdevkit2007/VOC2007/JPEGImages/000012.jpg')
#    h = image1.shape[0]
#    w = image1.shape[1]

    #print ('asdf %d')%h

    #print('shape len %d')%len(image.shape)
